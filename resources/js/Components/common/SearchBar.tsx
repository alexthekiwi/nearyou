    ...
    return (
        <div className="flex items-stretch gap-6">
            ...
            >
                ...
                <button
                    type="submit"
                    className="hover:text-magenta absolute bottom-0 right-3 top-0 transition-all"
                >
                    <svg
            ...
            {showClearSearch && (
                <button
                    title="Clear Search"
                    className="flex h-[50px] w-[50px] items-center justify-center rounded-md bg-gray text-white"
                    onClick={clearSearch}
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
